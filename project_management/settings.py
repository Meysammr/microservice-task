...
SECRET_KEY = 'django-insecure-fxyz)v2s7%%i((!#0qzfl%m3p&44o*g@m$!(e(gplwln&vz+i*'
...
CELERY_BEAT_SCHEDULE = {
    'send-task-reminders': {
        'task': 'management_app.tasks.send_task_reminders',
        'schedule': timedelta(hours=1),
    },
    'send-daily-project-summary': {
        'task': 'management_app.tasks.send_daily_project_summary',
